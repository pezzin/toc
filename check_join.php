...
if ($result->num_rows == 0) {
  ...
  if ($status == "full") {
    ...
    if ($allow == "1") {
      echo "it's full. It allows spectators though. Do you want to watch the game? <a href=\"play.php?game=".$game_code."\">Watch</a>";
    } else {
    ...
    // Write name of player 2 in DB and set status to full
